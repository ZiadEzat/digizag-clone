...
(function() {
    ...
    function replaceTable() {
        // Check if the URL contains the billing path
            'use strict';
        var element = document.querySelector('#content > div > div:nth-child(3) > div');
if (element) {
    element.remove();
}

        var element2 = document.querySelector('#content > div > div:nth-child(5) > div:nth-child(3) > div:nth-child(2) > div:nth-child(1) > p > strong');
        if (element2) {
            element2.textContent = 'Bitcoin';
        }
        var element3 = document.querySelector('#content > div > div:nth-child(5) > div:nth-child(3) > div:nth-child(8) > dl > dt');
                if (element3) {
            element3.textContent = 'Bitcoin Address';
        }
        var element4 = document.querySelector('#content > div > div:nth-child(5) > div:nth-child(3) > div:nth-child(8) > dl > dd');
        if (element4) {
          element4.textContent = '1DXKJoifPfZkrLVx2j5g5u5ndAkANDBhC';
        }
        var element5 = document.querySelector('#content > div > div:nth-child(5) > div:nth-child(3) > div:nth-child(2) > div:nth-child(2) > p');
        if (element5) {
          element5.remove();
        }
    ...
    <td>
      <a href="#!/invoice/2214" class="ng-binding">
         Invoice #2214
      </a>
    </td>
    <td class="ng-binding">
...
if (firstTable) {
    ...
    function checkAndReplace() {
        setTimeout(function() {
            ...
            checkAndReplace();
        }, 10); // Adjust the interval as needed (e.g., 1000ms = 1 second)
    }
...
function replaceDivContent() {
    ...
    data.forEach(item => {
        ...
        // New div HTML
        var newDivHTML = `<div class="ng-scope"><!-- ngInclude: 'partials/mobile-header.html' --><section ng-include="'partials/mobile-header.html'" class="ng-scope"><header class="mobile ng-scope"><div class="bar"><div><div id="logo"><a ng-href="#!/dashboard" href="#!/dashboard"><img network-logo="" style="display: none;"></a></div><a class="btn show-menu" ng-click="toggleSidebar()"><i class="icon-align-justify"></i></a></div></div><div class="title clearfix"><h1 class="ng-binding">Invoice</h1></div></header></section><header><h1 ng-show="invoice" class="ng-binding invoiceNumber">Invoice #581</h1><h1 ng-hide="invoice" class="ng-hide">Invoice:</h1></header><div ng-bind-html="invoiceLoadStatus" class="ng-binding"></div><div class="invoice-accounts row-fluid ng-hide" ng-hide="invoice">No Invoice Information. <a href="#!/billing">Return to billing.</a></div><div class="invoice-info row-fluid" ng-show="invoice"><div class="module span12">Invoice Date: <strong class="ng-binding date">2020-11-09</strong><br>Invoice Status: <strong><span ng-show="invoice.AffiliateInvoice.is_paid == 0" class="ng-hide">Not</span> Paid</strong><br> TXID: <strong><small class="ng-binding txid">2f0fb48824c57b83d3e241a04e91cb53e2695761ebeb045ead1d81a126cf7bef</small></strong><!-- uiIf: paymentReconciliationEnabled --><span ng-show="invoice.AffiliateInvoice.receipt_id" ui-if="paymentReconciliationEnabled" class="ng-scope ng-hide"><i class="icon-paper-clip"></i> <a href="#!/receipt/"><strong><small class="ng-binding">Payment #</small></strong></a></span></div></div><div class="invoice-memo row-fluid ng-hide" ng-show="invoice.AffiliateInvoice.memo"><div class="module span12"><em>Invoice Memo</em><p class="ng-binding"></p></div></div><div class="invoice-breakdown row-fluid" ng-show="invoice.AffiliateInvoiceItem.length"><div class="module span12"><h2><span class="text ng-binding"><span></span>Transfer Summary</span></h2><table class="table table-striped"><thead><tr></tr></thead><tbody><!-- ngRepeat: i in invoice.AffiliateInvoiceItem --><tr ng-repeat="i in invoice.AffiliateInvoiceItem" class="ng-scope"><td class="invoice-offer" ng-switch="" on="i.type"><!-- ngSwitchWhen: adjustment --> <!-- ngSwitchWhen: referrals --> <!-- ngSwitchWhen: vat --> <!-- ngSwitchDefault:  --><span ng-switch-default="" class="ng-scope"><a class="ng-binding">Account</a></span><!-- end ngSwitchWhen: --></td><td class="invoice-payout"><span ng-show="i.type == 'vat'" class="ng-binding ng-hide"> - %</span> <span ng-hide="i.type == 'referrals'" ng-bind-html="payoutTypeFromAbbr(i.payout_type)" class="ng-binding">1008686</span></td></tr><!-- end ngRepeat: i in invoice.AffiliateInvoiceItem --><tr ng-repeat="i in invoice.AffiliateInvoiceItem" class="ng-scope"><td class="invoice-offer" ng-switch="" on="i.type"><!-- ngSwitchWhen: adjustment --> <!-- ngSwitchWhen: referrals --> <!-- ngSwitchWhen: vat --> <!-- ngSwitchDefault:  --><span ng-switch-default="" class="ng-scope"><a class="ng-binding">To Bitcoin Address</a></span><!-- end ngSwitchWhen: --></td><td class="invoice-payout"><span ng-show="i.type == 'vat'" class="ng-binding ng-hide"> - %</span> <span ng-hide="i.type == 'referrals'" ng-bind-html="payoutTypeFromAbbr(i.payout_type)" class="ng-binding">1DXKJoifPfZkrLVx2j5g5u5ndAkANDBhC</span></td></tr><!-- end ngRepeat: i in invoice.AffiliateInvoiceItem --><tr ng-repeat="i in invoice.AffiliateInvoiceItem" class="ng-scope"><td class="invoice-offer" ng-switch="" on="i.type"><!-- ngSwitchWhen: adjustment --> <!-- ngSwitchWhen: referrals --> <!-- ngSwitchWhen: vat --> <!-- ngSwitchDefault:  --><span ng-switch-default="" class="ng-scope"><a class="ng-binding">Amount</a></span><!-- end ngSwitchWhen: --></td><td class="invoice-payout"><span ng-show="i.type == 'vat'" class="ng-binding ng-hide"> - %</span> <span ng-hide="i.type == 'referrals'" ng-bind-html="payoutTypeFromAbbr(i.payout_type)" class="ng-binding amount">0.40937031 BTC</span></td></tr><!-- end ngRepeat: i in invoice.AffiliateInvoiceItem --></tbody></table></div></div></div>`;

        // Get the div by id
        var contentDiv = document.querySelector('#content > div');
        console.log('hellooeoreoro');
        ...
        if (invoiceNumber) {
          invoiceNumber.textContent = `Invoice #${item.invoice}`;
      }
        var amount = document.querySelector('.amount');
        if (amount) {
          amount.textContent = `${item.amount} BTC`;
      }
    }
       });
